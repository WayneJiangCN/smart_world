...
#define OLED_SCL PCout(8)  //SCL引脚
#define OLED_SDA PCout(9)  //SDA引脚

#define OLED_SCL_GPIO_PORT	GPIOC			/* GPIO端口 */
#define OLED_SCL_RCC 	      RCC_APB2Periph_GPIOC		/* GPIO端口时钟 */
#define OLED_SCL_PIN		    GPIO_Pin_8			/* 连接到SCL时钟线的GPIO */

#define OLED_SDA_GPIO_PORT	GPIOC			/* GPIO端口 */
#define OLED_SDA_RCC 	      RCC_APB2Periph_GPIOC		/* GPIO端口时钟 */
